...
TOPICS = (
    types.MappingProxyType({"id": "variables",        "title": "Variables & Types",        "pct": 5,  "prereqs": []}),
    types.MappingProxyType({"id": "control_flow",     "title": "If / Else",                "pct": 10, "prereqs": ["variables"]}),
    types.MappingProxyType({"id": "loops",            "title": "For & While Loops",        "pct": 15, "prereqs": ["control_flow"]}),
    types.MappingProxyType({"id": "functions",        "title": "Functions",                "pct": 22, "prereqs": ["loops"]}),
    types.MappingProxyType({"id": "lists",            "title": "Lists & Indexing",         "pct": 28, "prereqs": ["functions"]}),
    types.MappingProxyType({"id": "dicts",            "title": "Dicts & Sets",             "pct": 34, "prereqs": ["lists"]}),
    types.MappingProxyType({"id": "strings",          "title": "String Methods",           "pct": 38, "prereqs": ["dicts"]}),
    types.MappingProxyType({"id": "file_io",          "title": "File I/O",                 "pct": 43, "prereqs": ["strings"]}),
    types.MappingProxyType({"id": "errors",           "title": "Error Handling",           "pct": 48, "prereqs": ["file_io"]}),
    types.MappingProxyType({"id": "comprehensions",   "title": "List Comprehensions",      "pct": 53, "prereqs": ["errors"]}),
    types.MappingProxyType({"id": "oop",              "title": "Classes & OOP",            "pct": 62, "prereqs": ["comprehensions"]}),
    types.MappingProxyType({"id": "modules",          "title": "Modules & Imports",        "pct": 66, "prereqs": ["oop"]}),
    types.MappingProxyType({"id": "iterators",        "title": "Iterators & Generators",   "pct": 71, "prereqs": ["modules"]}),
    types.MappingProxyType({"id": "decorators",       "title": "Decorators",               "pct": 76, "prereqs": ["iterators"]}),
    types.MappingProxyType({"id": "context_managers", "title": "Context Managers",         "pct": 80, "prereqs": ["decorators"]}),
    types.MappingProxyType({"id": "async",            "title": "Async / Await",            "pct": 86, "prereqs": ["context_managers"]}),
    types.MappingProxyType({"id": "type_hints",       "title": "Type Hints",               "pct": 89, "prereqs": ["async"]}),
    types.MappingProxyType({"id": "testing",          "title": "Testing (pytest)",         "pct": 93, "prereqs": ["type_hints"]}),
    types.MappingProxyType({"id": "packaging",        "title": "Packaging & pip",          "pct": 96, "prereqs": ["testing"]}),
    types.MappingProxyType({"id": "patterns",         "title": "Advanced Patterns",        "pct": 100,"prereqs": ["packaging"]}),
)
